    ...
    crops.forEach((crop) => {
      const row = `
        <tr class="border-t border-gray-200 hover:bg-gray-50">
          ...
          <td class="px-4 py-2 text-gray-700">${crop.field_code}</td>
...
async function saveOrUpdateCrop() {
  ...
  const field_code = document.getElementById('fields').value;
...
async function editCrop(cropCode) {
  ...
  try {
    ...
    document.querySelector('input[id="fields"]').value = crop.field_code;
